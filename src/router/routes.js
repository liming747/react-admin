...
import MenuOne from '../views/InStock/EnterTheWarehouse';
import MenuTwo from '../views/InStock/OutOfTheWarehouse';
import FinanceOne from '../views/Finance/Day';
import FinanceTwo from '../views/Finance/Month';
// import About from '../views/about/About';
// import InventoryEntry from '../views/InventoryEntry';
export const routes = [
	...
	{ path: '/InStock/EnterTheWarehouse', component: MenuOne },
	{ path: '/InStock/OutOfTheWarehouse', component: MenuTwo },
	{ path: '/Finance/Day', component: FinanceOne },
	{ path: '/Finance/Month', component: FinanceTwo },
